...
complexity would be far worse, O(2\textsuperscript{(x+y)}). The dynamic 
approach achieves this by eliminating redundant calculations by creating
subproblems to be reused.
